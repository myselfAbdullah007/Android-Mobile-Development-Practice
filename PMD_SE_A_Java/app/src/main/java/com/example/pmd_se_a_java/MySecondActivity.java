...
import com.example.pmd_se_a_java.databinding.ActivityMySecondBinding;
...
public class MySecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_my_second);
